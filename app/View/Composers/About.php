...
class About extends Composer
{
    ...
    private function getAboutData()
    {
        ...
        return [
            ...
            'testimonials' => [
                ...
                'shortcode' => $this->getAcfFieldSafe('about_testimonials_shortcode', $postId, '[trustindex no-registration=google]'),
            ],
        ];
    }
    ...
    private function getBreadcrumbData($postId)
    {
        ...
        if (function_exists('get_field')) {
            $breadcrumbRows = \get_field('about_breadcrumb_items', $postId);
