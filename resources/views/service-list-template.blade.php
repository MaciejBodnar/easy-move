                        ...
                        <div class="overflow-hidden bg-[#ddd]">
                            @if ($itemImage)
                                <img src="{{ esc_url($itemImage) }}" alt="{{ esc_attr($itemTitle) }}"
                                    class="h-65 w-full object-cover md:h-80" />
                            @else
                                <div
                                    class="flex h-65 w-full items-center justify-center bg-[linear-gradient(90deg,#2f2309_0%,#4a360a_50%,#2f2309_100%)] text-white/80 md:h-80">
                        ...
                        <div class="flex flex-col justify-center pt-1 md:max-w-130">
                            ...
                            <div class="mt-6">
                                <a href="{{ esc_url($buttonUrl) }}"
                                    class="inline-flex min-w-33 items-center justify-center bg-[#e6c15a] px-6 py-3 text-[12px] uppercase tracking-[0.08em] text-[#3d2e12] transition hover:bg-[#d9b24c]">
                                    {{ $buttonTitle }}
                                </a>
                            </div>
                        </div>
